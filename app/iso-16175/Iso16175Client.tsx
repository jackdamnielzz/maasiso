...
export default function Iso16175Client({ layout }: Props) {
  useEffect(() => {
    console.log('Initializing ISO 16175 Client component');
    
    // Initialize scroll reveal animations
    const script = document.createElement('script');
    script.src = '/iso-16175/scroll-reveal.js';
    script.async = true;
    ...
    return () => {
      console.log('Cleaning up ISO 16175 Client component');
  ...
  return (
    <main className="flex-1 bg-gradient-to-b from-blue-50 to-white" data-testid="iso16175-dynamic-content">
                    ...
                    <>
                      <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-center mb-6 relative inline-block">
                          {block.title || 'ISO 16175 Diensten'}
                      ...
                      <div className="container mx-auto px-4 sm:px-6 lg:px-8 mb-8 relative" data-testid="iso16175-feature-cards-grid">
                        <FeatureCarousel>
              ...
              <section key={block.id} className="bg-[#091E42] text-white py-16 md:py-24 relative overflow-hidden">
                ...
                <div className="container-custom text-center relative z-10 px-4 sm:px-6 lg:px-8">
                  <h2 className="text-3xl md:text-4xl font-bold mb-8 leading-tight">
                    {block.title || "Klaar voor ISO 16175 certificering?"}
                  </h2>
                  <p className="text-xl text-white/90 mb-10 max-w-3xl mx-auto leading-relaxed">
                    {block.description || "Neem contact op voor een vrijblijvend gesprek over hoe MaasISO u kan helpen met ISO 16175 certificering en documentbeheer."}
                  </p>
                  {block.ctaButton ? (
                    <a
                      href={block.ctaButton.link}
