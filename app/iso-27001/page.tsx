...
export default async function Iso27001Page() {
  ...
  if (!hasValidContent) {
    return (
      <main className="flex-1 bg-gradient-to-b from-blue-50 to-white" data-testid="iso27001-fallback-content">
  ...
  const mainContent = (
    <main className="flex-1 bg-gradient-to-b from-blue-50 to-white" data-testid="iso27001-dynamic-content">
                    ...
                    <>
                      <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-center mb-6 relative inline-block">
                          {block.title || 'ISO 27001 Diensten'}
                      ...
                      <div className="container mx-auto px-4 sm:px-6 lg:px-8 mb-8" data-testid="iso27001-feature-cards-carousel">
                        <FeatureCarousel>
              ...
              <section key={block.id} className="bg-[#091E42] text-white py-16 md:py-24 relative overflow-hidden">
                ...
                <div className="container-custom text-center relative z-10 px-4 sm:px-6 lg:px-8">
                  <h2 className="text-3xl md:text-4xl font-bold mb-8 leading-tight">
                    {block.title || "Klaar voor ISO 27001 certificering?"}
                  </h2>
                  <p className="text-xl text-white/90 mb-10 max-w-3xl mx-auto leading-relaxed">
                    {block.description || "Neem contact op voor een vrijblijvend gesprek over hoe MaasISO u kan helpen met ISO 27001 certificering en informatiebeveiliging."}
                  </p>
                  <a
                    href={block.link}
                    className="primary-button hover:bg-[#FF9B20] hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1"
  ...
  const relatedServices = getRelatedServices('iso-27001');

  if (!hasValidContent) {
    return (
      <>
        <ServiceAnalytics serviceName="ISO 27001" />
        {mainContent}
      </>
    );
  }
