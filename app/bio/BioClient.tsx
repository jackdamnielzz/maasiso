...
export default function BioClient({ layout }: Props) {
  useEffect(() => {
    console.log('Initializing BIO Client component');
    
    // Initialize scroll reveal animations
    const script = document.createElement('script');
    script.src = '/bio/scroll-reveal.js';
    script.async = true;
    ...
    return () => {
      console.log('Cleaning up BIO Client component');
  ...
  return (
    <main className="flex-1 bg-gradient-to-b from-blue-50 to-white" data-testid="bio-dynamic-content">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                  {block.features && block.features.length > 0 ? (
                    <>
                      ...
                      <div className="container mx-auto px-4 sm:px-6 lg:px-8 mb-8 relative" data-testid="bio-feature-cards-grid">
                        <FeatureCarousel>
              ...
              <section key={block.id} className="bg-[#091E42] text-white py-16 md:py-24 relative overflow-hidden">
                ...
                <div className="container-custom text-center relative z-10 px-4 sm:px-6 lg:px-8">
                  <h2 className="text-3xl md:text-4xl font-bold mb-8 leading-tight">
                    {block.title || "Klaar voor BIO certificering?"}
                  </h2>
                  <p className="text-xl text-white/90 mb-10 max-w-3xl mx-auto leading-relaxed">
                    {block.description || "Neem contact op voor een vrijblijvend gesprek over hoe MaasISO u kan helpen met BIO certificering en informatiebeveiliging."}
                  </p>
                  {block.ctaButton ? (
                    <a
                      href={block.ctaButton.link}
