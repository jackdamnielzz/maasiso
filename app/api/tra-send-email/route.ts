...
export async function POST(request: NextRequest) {
  try {
    ...
    // Send confirmation email (without PDF attachment for now — PDF is generated client-side)
    // Resend requires verified domain to send from custom address.
    // Use onboarding@resend.dev as fallback until maasiso.nl is verified in Resend.
