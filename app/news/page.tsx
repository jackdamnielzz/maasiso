...
export default async function NewsPage() {
  ...
  try {
    // Fetch page data inside try block to ensure proper error handling
    ...
    // Ensure page has required fields with defaults if page data is missing
        ...
        <section className="bg-gray-50 py-16">
          <div className="container-custom">
            <Suspense fallback={<LoadingSpinner />}>
              <NewsPageClientWrapper articles={articles} page={validatedPage} />
            </Suspense>
          </div>
        </section>
      </main>
