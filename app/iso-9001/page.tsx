...
export default async function Iso9001Page() {
  ...
  const mainContent = (
    <main className="flex-1 bg-gradient-to-b from-blue-50 to-white" data-testid="iso9001-dynamic-content">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                  {block.features && block.features.length > 0 ? (
                    <>
                      ...
                      <div className="container mx-auto px-4 sm:px-6 lg:px-8 mb-8 relative" data-testid="iso9001-feature-cards-grid">
                        <FeatureCarousel>
              ...
              <section key={block.id} className="bg-[#091E42] text-white py-20 md:py-32 relative overflow-hidden">
                ...
                <div className="container-custom text-center relative z-10 px-4 sm:px-6 lg:px-8">
                  <h2 className="text-3xl md:text-4xl font-bold mb-10 leading-tight">
                    {block.title || "Klaar voor ISO 9001 certificering?"}
                  </h2>
                  <p className="text-xl text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed">
                    {block.description || "Neem contact op voor een vrijblijvend gesprek over hoe MaasISO u kan helpen met ISO 9001 certificering en kwaliteitsmanagement."}
                  </p>
                  <a
                    href={block.link}
                    className="primary-button hover:bg-[#FF9B20] hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1"
